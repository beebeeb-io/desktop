# Graph Report - desktop-flow7-5  (2026-09-25)

## Corpus Check
- 138 files · ~341,735 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2320 nodes · 4841 edges · 29 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 776 edges (avg confidence: 0.8)
...
2. `load()` - 68 edges
3. `load()` - 67 edges
4. `EngineBridge` - 56 edges
5. `StateDb` - 55 edges
6. `command()` - 46 edges
7. `test_bridge_with_api()` - 33 edges
8. `run()` - 30 edges
...
Cohesion: 0.01
Nodes (300): load(), ensure_account_id_mints_persists_and_is_stable_across_relaunch(), ensure_directory(), linux_thumbnail_source_path_for_entry(), shared_metadata_uses_placeholder_for_authenticated_traversal_name(), legacy_platform_keychain_store(), migrate_legacy_keychain_to_account(), platform_keychain_store_for() (+292 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (209): is_conflict(), is_text_file(), apply_metadata_file_row(), apply_shared_context(), apply_shared_metadata_file_row(), apply_snapshot(), apply_sync_op(), audit_1244_apply_sync_op_trash_echo_preserves_local_trashing_owner() (+201 more)
...
Cohesion: 0.03
Nodes (65): AccountConfig, AccountId, AccountRuntime, active_account_after_synthesis_is_default_shape(), active_account_empty_registry_errs(), fixed_id(), synthesize_is_idempotent(), synthesize_single_account() (+57 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (71): engine_internal_filters_state_dir_and_lock(), relative_db_path_is_slash_joined_without_leading_slash(), bind_ipc_listener(), capabilities_for_status(), file_entry_payload(), file_entry_payload_for_db(), file_entry_payload_without_contract(), file_status_string() (+63 more)
...
Cohesion: 0.05
Nodes (61): db_placeholder_path(), decide_size_action(), fail_transfer(), fetch_data_callback(), mark_in_sync(), mark_not_in_sync(), normalized_path(), notify_delete_completion_callback() (+53 more)
...
Cohesion: 0.14
Nodes (27): path_is_engine_internal(), relative_db_path(), assert_uploading_row(), debounce_loop(), dispatch_local_create(), engine_delete_suppress(), engine_delete_suppression_distinguishes_paths(), engine_delete_suppression_is_consumed_once() (+19 more)
...
- **Why does `load()` connect `Community 0` to `Community 8`, `Community 1`, `Community 2`, `Community 15`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `commandUnavailableLabel()` connect `Community 2` to `Community 0`, `Community 9`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 9`, `Community 12`?**
